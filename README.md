...
- **Software Engineering** – Robust Java applications with MVC architecture and Design Patterns.
- **Databases** – Design and management of SQL (MySQL, PostgreSQL) and NoSQL systems.
...
- [**AI-Workflow-Assistant**](https://github.com/dasafo/AI-Workflow-Assistant): Intelligent automation system that integrates AI to process and automate tasks.
...
### ☕ Java Ecosystem & Software Dev

- [**Web Products MVC**](https://github.com/dasafo/Web_Productos_MVC_Java): Java EE Web application implementing manual MVC architecture (JSP/Servlets) with PostgreSQL.
- [**Supermarket REST API**](https://github.com/dasafo/SupermercadoPruebaTecnica): Scalable Spring Boot API for sales management using layered architecture and JPA.
- [**Pet Grooming Manager**](https://github.com/dasafo/Peluqueria_Canina_Java): Desktop application (Swing) for managing clients and pets with persistent data (MySQL).
- [**Car Dealership System**](https://github.com/dasafo/Concesionario_Java): Inventory management system built with Java Swing and Hibernate.
- [**Auth Security System**](https://github.com/dasafo/Login_basico_Java): Role-based authentication demonstration with secure credential handling.

### 🎮 Game Development

- [**Crazy Cars**](https://github.com/dasafo/cars-game): Fast-paced 2D racing game developed with **Python** and **Pygame**.
...
![dasafodata]([https://github.com/dasafo/dasafo/blob/5e4191714188fa5471ecc84e128b657b8103b2e9/advertising-billboard-with-dasafodata-in-a-colourf-4aObr8ndR0Cbd0naAtVCsA-LP0EEbw9Rrq6ixUxWkGZwQ.jpeg](https://github.com/dasafo/dasafo/blob/main/dasfo.png))
